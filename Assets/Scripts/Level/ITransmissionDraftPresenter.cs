...
namespace Game.Level
{
    ...
    /// apart. The reward director rolls WHAT is offered; the presenter only shows it.
    /// </summary>
    public interface ITransmissionDraftPresenter
    {
        ...
        /// </summary>
        bool Present(IReadOnlyList<TransmissionBoonDefinition> offer, RewardTier tier,
